...
import { idlFactory } from './icpbuilder.did.js';
export { idlFactory } from './icpbuilder.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ICPBUILDER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./icpbuilder.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the icpbuilder canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./icpbuilder.did.js")._SERVICE>}
 */
export const icpbuilder = createActor(canisterId);
